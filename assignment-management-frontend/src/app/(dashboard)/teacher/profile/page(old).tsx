      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center mb-6">
          ...
          <div className="ml-4">
            ...
            <span className="text-sm text-white bg-primary-600 px-2 py-0.5 rounded-full">{user?.role}</span>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={profileForm.handleSubmit(onUpdateProfile)} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {profileForm.formState.errors.firstName && <p className="text-sm text-danger-600">{profileForm.formState.errors.firstName.message}</p>}
            </div>
            <div>
              ...
              {profileForm.formState.errors.lastName && <p className="text-sm text-danger-600">{profileForm.formState.errors.lastName.message}</p>}
            </div>
          </div>
          <div>
            ...
            {profileForm.formState.errors.email && <p className="text-sm text-danger-600">{profileForm.formState.errors.email.message}</p>}
          </div>
